        ...
        <div className="space-y-6">
          <Card>
            ...
            <CardContent className="grid grid-cols-2 gap-4">
              <Link href="/teams" className="py-5 px-4 rounded-2xl border border-brand-secondary/40 bg-gradient-to-br from-brand-secondary/15 to-bg-surface shadow-[0_4px_20px_0_rgba(16,185,129,0.15)] active:scale-95 transition-all duration-300 flex flex-col items-center justify-center text-center gap-3 relative overflow-hidden">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-brand-secondary to-green-500 flex items-center justify-center text-white shadow-[0_0_15px_rgba(16,185,129,0.4)] z-10">
                  <Shield size={26} strokeWidth={2.5} />
                </div>
                <span className="text-sm font-bold text-text-primary z-10 mt-1">Add Team</span>
              </Link>
              <Link href="/players" className="py-5 px-4 rounded-2xl border border-blue-500/40 bg-gradient-to-br from-blue-500/15 to-bg-surface shadow-[0_4px_20px_0_rgba(59,130,246,0.15)] active:scale-95 transition-all duration-300 flex flex-col items-center justify-center text-center gap-3 relative overflow-hidden">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-white shadow-[0_0_15px_rgba(59,130,246,0.4)] z-10">
                  <User size={26} strokeWidth={2.5} />
                </div>
                <span className="text-sm font-bold text-text-primary z-10 mt-1">Add Player</span>
              </Link>
            </CardContent>
          </Card>
